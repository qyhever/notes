...
### 安装 v2raya
ArchLinux 用yay -S v2raya 命令一键安装 [v2raya](https://v2raya.org/docs/prologue/installation/archlinux/)
...
5. 特殊模式： 关闭 （不要选择 supervisor, 这个选项会导致[懒猫微服](https://lazycat.cloud/)应用打不开）
6. TCPFastOpen: 关闭
7. 嗅探： Http + TLS + Quic
8. 多路复用： 关闭
9. 自动更新订阅： 关闭
...
## Reference
- [最佳代理实践](https://manateelazycat.github.io/2025/08/31/best-proxy/)
